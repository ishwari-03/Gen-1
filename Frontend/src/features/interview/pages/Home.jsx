...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            setError("An error occurred while generating your interview report. Please check your input and try again.")
            setIsGenerating(false)
        }
    }
    ...
    if (isGenerating) {
        return (
            <main className='loading-screen'>
                ...
                <p style={{marginTop: '1rem'}}>This may take up to 30 seconds...</p>
            </main>
        )
    }
    ...
    return (
        ...
        <LogoutButton />
                    ...
                    <div className='panel panel--left'>
                        ...
                        <textarea
                            ...
                            onChange={(e) => {
                                ...
                                setJobDescriptionChars(text.length)
                            }}
                        ...
                        <div className='char-counter'>
                            {jobDescriptionChars} / 5000 chars
                            {jobDescriptionChars >= 5000 && (
                                <span style={{ color: 'red', marginLeft: '1rem' }}>
                                    Limit reached: maximum 5000 characters.
                                </span>
                            )}
                        </div>
                    </div>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className='dropzone' htmlFor='resume'>
                                ...
                                {selectedFile && <p className='dropzone__file'>Selected: {selectedFile.name}</p>}
                                <input 
                                    ref={resumeInputRef} 
                                    hidden 
                                    type='file' 
            ...
            <footer className='page-footer'>
                ...
                <span>&copy; 2026 InterviewGen-1. By Ish.</span>
